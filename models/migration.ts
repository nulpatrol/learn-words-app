...
const languagesList = ['en', 'de', 'pl', 'uk', 'da'];
...
export default () => new Promise(async (resolve, reject) => {
    try {
        ...
        await processQuery('insert into settings (key, value) VALUES ("main_language", "de")');
        ...
        const languagesPromises = languagesList.map(lang =>
            processQuery(`insert into languages (key) VALUES (?)`, [lang]));
